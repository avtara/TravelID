                        ...
                        <div class="d-flex order-lg-2 ml-auto">
                            <div class="dropdown">
                                <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                                    <span class="avatar" >MAK</span>
                                    <span class="ml-2 d-none d-lg-block">
                                        <span class="text-default">Muhammad Avtara Khrisna</span>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg order-lg-first">
                            <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo base_url()?>" class="nav-link"><i class="fa fa-ticket"></i> Tambah Tiket</a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo base_url()?>" class="nav-link"><i class="fa fa-train"></i> Tambah Kereta</a>
                                </li>
                            </ul>
                        </div>
                    </div>
